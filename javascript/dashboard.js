...
//     "/data/all-current?period=4&target=" + targetDate
//   )
...
//   if (
//     (type == "expenses" || type == "earnings") &&
//     period == 4 &&
//     date.split("-")[0] == String(currentYear)
//   ) {
//     if (type == "expenses") {
//       const expenseContainer = document.getElementById("expense-container");
//       expenseContainer.innerHTML = "";
//       expenseContainer.append(
//         generateTableUI(0, userData.expenses, userData.currency, upcoming)
//       );
//     } else if (type == "earnings") {
//       const earningContainer = document.getElementById("earning-container");
//       earningContainer.innerHTML = "";
//       earningContainer.append(
//         generateTableUI(1, userData.earnings, userData.currency, upcoming)
//       );
//     }
//   } else if (type == "charts") {
...
//       });
//   } else {
//     fetch("/data/" + type + "?period=" + period + "&target=" + date)
//       .then((response) => response.json())
//       .then((responseData) => {
//         if (type == "budgets") {
...
//           expenseContainer.innerHTML = "";
//           expenseContainer.append(
//             generateTableUI(0, responseData, userData.currency, upcoming)
//           );
//         } else if (type == "earnings") {
//           const earningContainer = document.getElementById("earning-container");
//           earningContainer.innerHTML = "";
//           earningContainer.append(
//             generateTableUI(1, responseData, userData.currency, upcoming)
//           );
//         }
//       });
//   }
...
//   const dotCarousel = carouselButtons(
//     chartData,
//     "overview-chart-dots",
//     "chart-container",
//     1,
...
//   const profileComponents = generateProfileUI(
//     userData.username,
//     userData.email,
...
//   const dotCarousel = carouselButtons(
//     budgets,
//     "overview-budget-dots",
//     "limited-budgets-container",
//     3,
//     generateLimitedOverviewBudgets
//   );
...
//           datasets: [
//             {
//               data: Object.entries(data.total).map(
...
//             {
//               data: Object.entries(data.total).map(
//                 ([key, value]) => value.finalized
//               ),
//               hidden: true,
//             },
//             {
//               data: Object.entries(data.total).map(
//                 ([key, value]) => value.upcoming
//               ),
//               hidden: true,
//             },
//           ],
...
//                     "Total: " +
//                       userData.currency +
//                       formatNumber(dataObject.data[context.dataIndex]),
//                     "━━━━━━━━━",
//                     "Finalized: " +
//                       userData.currency +
//                       formatNumber(
...
//       budget_used.textContent =
//         formatNumber((budget.totalUsedAmount / budget.amount) * 100, false) +
//         "% used";
...
//         path2.setAttribute(
//           "stroke-dasharray",
//           (totalAmount / budget.amount) * path2Length + " " + path2Length
//         );
...
//         path3.setAttribute(
//           "stroke-dasharray",
//           (fillAmount / budget.amount) * path3Length + " " + path3Length
//         );
...
//   const expenseTable = generateTableUI(
//     0,
//     userData.expenses,
//     userData.currency,
//     0,
...
//   const earningTable = generateTableUI(
//     1,
//     userData.earnings,
//     userData.currency,
//     0,
...
//   bigExpense.textContent =
//     userData.currency + formatNumber(expenseSums.totalSum);
//   document.getElementById("final-expense-stat").textContent =
//     userData.currency + formatNumber(expenseSums.totalFinalized);
//   document.getElementById("upcoming-expense-stat").textContent =
//     userData.currency + formatNumber(expenseSums.totalUpcoming);

//   // Sums for earnings
//   const bigEarning = document.getElementById("total-earning-stat");
//   bigEarning.textContent =
//     userData.currency + formatNumber(earningSums.totalSum);
//   document.getElementById("final-earning-stat").textContent =
//     userData.currency + formatNumber(earningSums.totalFinalized);
//   document.getElementById("upcoming-earning-stat").textContent =
//     userData.currency + formatNumber(earningSums.totalUpcoming);
...
//   document.getElementById("stat-start-date").textContent =
//     startDate.toLocaleDateString("en-us", formattingOptions);
//   document.getElementById("stat-end-date").textContent =
//     endDate.toLocaleDateString("en-us", formattingOptions);
// }
...
//   const totalAmounts = totalBudgetsAndAmounts(
//     expenses,
//     period,
//     newStartDate,
//     newEndDate
...
//   const earningsData = earningsPerMonth(
//     earnings,
//     period,
//     startDate,
//     newStartDate,
...
//     currCategory =
//       currCategory.length > 15
//         ? currCategory.substring(0, 15) + "..."
//         : currCategory;
...
//           };
//         }
//         amountPerCategory[currCategory]["finalized"] =
//           amountPerCategory[currCategory]["finalized"] + amount;
//         amountPerCategory[currCategory]["total"] =
//           amountPerCategory[currCategory]["total"] + amount;
//         totalSum += amount;
...
//           };
//         }
//         amountPerCategory[currCategory]["upcoming"] =
//           amountPerCategory[currCategory]["upcoming"] + amount;
//         amountPerCategory[currCategory]["total"] =
//           amountPerCategory[currCategory]["total"] + amount;
//         totalSum += amount;
...
//     descriptionDates =
//       firstDate.toLocaleDateString("en-us", formattingOptions) +
//       " - " +
//       lastDate.toLocaleDateString("en-us", formattingOptions);
...
//           data.values[curMonth] = parseFloat(
//             (data.values[curMonth] + amount).toFixed(2)
//           );
//         } else {
//           dataGrey[curMonth] = parseFloat(
//             (dataGrey[curMonth] + amount).toFixed(2)
//           );
//         }
//       } else {
...
//         if (curDate <= todayDate) {
//           data.values[index] = parseFloat(
//             (data.values[index] + amount).toFixed(2)
//           );
//         } else {
