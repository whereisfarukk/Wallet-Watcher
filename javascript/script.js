...
//   startDate = new Date(
//     UTCStartDate.setDate(UTCStartDate.getDate() - UTCStartDate.getDay())
//   );
//   var endDate = new Date(
//     UTCStartDate.setDate(UTCStartDate.getDate() + (6 - UTCStartDate.getDay()))
//   );
...
//     });
//     weekLabels.unshift(
//       newStart.toLocaleDateString("en-us", formatting) +
//         " - " +
//         newEnd.toLocaleDateString("en-us", formatting)
//     );
//     weekValues.push(0);
//   }
...
//     dateSelector.value = configureFilterDate(
//       dateSelector.value,
//       periodSelector.value
//     );
//     upcomingSelector.value = configureFilterUpcoming(
//       dateSelector.value,
//       periodSelector.value,
//       upcomingSelector.value
//     );
//     updateData(
//       type,
//       periodSelector.value,
...
//   dateSelector.value = configureFilterDate(
//     getISOFormatDate(new Date()),
//     periodSelector.value
//   );
//   dateSelector.addEventListener("change", () => {
//     if (
//       periodSelector.value == 4 ||
//       periodSelector.value == -1 ||
//       periodSelector.value == -2
//     ) {
//       dateSelector.value = configureFilterDate(
//         dateSelector.value,
//         periodSelector.value,
...
//     upcomingSelector.title =
//       "Select whether to show or hide upcoming occurances";
...
//     // The viewing period ends before today's date, so there are no upcoming things to show.
//     return 0;
//   } else if (startDate > todayDate) {
//     // The viewing period starts after today's date, so there are no "past" items.
//     return 2;
//   } else {
//     // If today's date is in the viewing period, the setting should stay on what the user had before.
//     return previous;
//   }
// }
...
//   if (!panelClick) {
//     if (!propagation) {
//       // To avoid propagation issues, do not set to 'none' if it was the options' button click
//       optionsPanel.style.display = "none";
//     }
//   }
// }
...
//             "radial-gradient(" + colorToUse + " 65%, transparent 90%)";
...
//       pic.src = "../static/images/profileImages/" + imageToUse + ".svg";
//       pic.style.background =
//         "radial-gradient(" + color + " 65%, transparent 90%)";
...
//     popupText.id = "popup-text";
//     popupText.innerText =
//       "This website uses cookies to provide a personalized experience. Cookies are essential to the functionality of this website. When you click 'I Accept', you consent to our use of cookies.";
...
//         document.getElementById("dashboard-left").style.transform =
//           "translateY(0px)";
//       }
//       if (logo.classList.contains("hamburg")) {
...
//       if (document.getElementById("dashboard-left")) {
//         document.getElementById("dashboard-left").style.transform =
//           "translateY(calc(-1.2 * var(--navPad)))";
//       }
//       if (logo.classList.contains("hamburg")) {
//         document.getElementsByTagName("header")[0].style.transform =
//           "translateY(-70px)";
...
//     if (
//       child.scrollLeft != 0 &&
//       child.scrollLeft + parent.scrollWidth != child.scrollWidth
//     ) {
...
//         dotClick(slide, uniqueClass, containerId, () => {
//           return nextSlideGenerator(items, slide, maxShow);
//         });
//       }
...
//       // This is the previously selected dot
//       if (index == slideNum) {
//         // This means the active dot was clicked again
//         return index;
//       } else {
//         previousSlide = index;
...
// function generateCurveProgress(
//   fillAmount,
//   greyAmount,
//   totalAmount,
//   width = "200",
...
//     path2.setAttribute(
//       "stroke-dasharray",
//       (greyAmount / totalAmount) * path2Length + " " + path2Length
//     );
...
//     path3.setAttribute(
//       "stroke-dasharray",
//       (fillAmount / totalAmount) * path2Length + " " + path2Length
//     );
...
//       recur_div.title =
//         "This budget recurs " + period.toLocaleLowerCase() + ".";
...
//       currency + formatNumber(budgets[key].totalUsedAmount);
...
//     const svg = generateCurveProgress(
//       budgets[key].usedAmount,
//       budgets[key].totalUsedAmount,
//       budgets[key].amount
//     );
...
//       window.location =
//         "/form/update-budget?id=" +
//         key +
//         "&duplicate=False&date=" +
//         formatDateString +
//         "&inactive=" +
//         inactive;
//     });
...
//             "This budget may not exist anymore. Further action needed."
//           );
...
//         window.location =
//           "/form/update-" + TYPES[type] + "?id=" + key + "&duplicate=True";
//       });
...
//           recStart.textContent = formatDate.toLocaleDateString(
//             "en-us",
//             getDateFormattingOptions()
//           );
//         } else {
...
//           recEnd.textContent = formatDate.toLocaleDateString(
//             "en-us",
//             getDateFormattingOptions()
//           );
//         } else {
...
//     if (limit) {
//       const sortedElements = sortByStartDate(
//         Array.prototype.slice.call(unsortedRows.children),
//         ascendingOrder
//       );
...
//       elements[i].querySelector(".start-date").dataset.startDate
//     ).getTime();
//     var prevDate = new Date(
//       elements[j].querySelector(".start-date").dataset.startDate
//     ).getTime();
